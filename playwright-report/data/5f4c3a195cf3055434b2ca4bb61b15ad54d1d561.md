...
```
Error: A snapshot doesn't exist at C:\Users\legra\Desktop\JordanNguyenWebsitePortfolio\playwright\snapshots\portfolio.spec.ts-snapshots\skills-matrix-mobile-chrome-win32.png, writing actual.
```
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e8] [cursor=pointer]: "Time: 12:01:48"
